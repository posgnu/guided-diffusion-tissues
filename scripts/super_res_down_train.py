...
from guided_diffusion.image_datasets import load_superres_downsampled_data, _list_image_files_train_valid_test
...
def main():
    ...
    train_data = load_superres_downsampled_data(
        paths = train_paths,
...
def load_data_for_validation(
    ...
    data = next(load_superres_downsampled_data(
        paths = valid_paths,
